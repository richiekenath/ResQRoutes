...
<title>24x7 Ambulance Booking | ResQRoutes</title>
<!--Bootstrap -->
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Choose from the available categories <br/> <span> BASIC, ADVANCED, Patient Transfer, Mortuary Services</span></h2>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab"> Ambulance </a></li>
        </ul>
      </div>
